...
class Frontend {
	...
	public function meta_robots() {
		...
		_deprecated_function( __CLASS__ . '::' . __METHOD__, '{VERSION} of the Form Pages WPForms addon', __CLASS__ . '::meta_tags()' );
	...
	public function yoast_seo_description() {
		...
		_deprecated_function( __CLASS__ . '::' . __METHOD__, '{VERSION} of the Form Pages WPForms addon', __CLASS__ . '::get_description()' );
